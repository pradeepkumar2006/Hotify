...
* **Intelligent Search:** Quickly find any song with smart matching algorithms and a convenient recent search history.
* **Personalized Playlists:** Create, customize, and manage your own playlists. Add custom names, descriptions, and even upload gallery pictures for playlist covers!
* **Liked Songs Collection:** Never lose track of a favorite track. Save it directly to your Liked Songs library.
* **Share Your Vibe:** View and share your listening statistics with the beautifully designed "My Vibeflow Vibe" card, summarizing your top minutes played, favorite songs, and artists.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/pradeepkumar2006/Hotify.git
   ```
...
*Vibeflow - Free on Vibeflow. Enjoy your vibe!* 🔥
